...
def airplaneFunction():
	gas = float(input("How much gas would you like in your airplane (in liters)?: "))
	passengers = int(input("Please enter the number of passengers traveling in the airplane with you today. Please note that you may only have a maximum of 25 passengers."))
	AirplaneSpeed = float(input("Please enter the speed of the boat in miles per hour (this speed will be converted into km/hr)."))
	airplane = Airplane(AirplaneSpeed, gas, 15, passengers, False)

switcher = {"car": carFunction, "boat": boatFunction, "airplane": airplaneFunction}
